...
<?php include('../views/tamplates/home-page-slider.php'); ?>
  <!-- Page Title -->
				...
				<div class="row">
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<!-- End Post Info -->
							<!-- Post Image -->
							<a href="page-blog-post-right-sidebar.html"><img src="../assets/img/pdam/air.jpg" class="post-image" alt="Post Title"></a>
							<!-- End Post Image -->
							<!-- Post Title & Summary -->
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<a href="page-blog-post-right-sidebar.html"><img src="../assets/img/pdam/air2.jpg" class="post-image" alt="Post Title"></a>
							<div class="post-title">
					...
					<div class="col-md-4 col-sm-6">
						<div class="blog-post">
							...
							<a href="page-blog-post-right-sidebar.html"><img src="../assets/img/pdam/air3.jpg" class="post-image" alt="Post Title"></a>
							<div class="post-title">
